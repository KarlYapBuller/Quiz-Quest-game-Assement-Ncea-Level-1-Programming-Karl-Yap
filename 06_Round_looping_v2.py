#Round looping component version 2
#The Round Looping component now works as intended
#The problem of that if the User wants to quit the game (exit code 'xxx') and
